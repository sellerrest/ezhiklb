...
const badgeVariants = cva('inline-flex items-center rounded-md border px-2.5 py-0 text-xs font-normal transition-colors focus:outline-none focus:ring-2 focus:ring-ring', {
  variants: {
    variant: {
